      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.section}>
          ...
          <Text style={[s.text, { color: c.textMuted }]}>
            ...
            <Text style={s.boldSub}>1.4. Звільнення від відповідальності.</Text> Розробники та адміністрація AuMentem не здійснюють фізичного нагляду за локаціями у реальному світі та не несуть відповідальності за будь-які травми, нещасні випадки, погіршення стану здоров'я, пошкодження майна пристроїв чи інші інциденти, що можуть статися з Користувачем під час користування додатку.{"\n\n"}
        ...
        <View style={[s.footer, { borderColor: c.border }]}>
           ...
           <Pressable style={s.contactBtn} onPress={() => Linking.openURL('mailto:am.altera.noreply@gmail.com')}>
              ...
              <Text style={[s.contactText, { color: c.accent }]}>am.altera.noreply@gmail.com</Text>
           </Pressable>
